---
applyTo: "**"
description: "Project-specific conventions for mcpbridge-go. Use when: working with daemon process management, YAML configuration parsing, MCP dynamicgeneration, error handling in background services, or testing daemon lifecycle."
---
...
- Build tasks: see `Makefile` and `makefile.instructions.md`
